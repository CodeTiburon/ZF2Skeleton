...
class Module
{
    public function onBootstrap(MvcEvent $e)
    {
        ...
        /** @var \Auth\Event\AuthenticationListener $moduleRouteListener */
        $moduleRouteListener = $serviceManager->get('Auth\AuthenticationListener');

        /** @var \Auth\Storage\Session $storage */
        $storage = $serviceManager->get('Auth\Storage\SessionStorage');
